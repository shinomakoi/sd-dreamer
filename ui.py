...
class Ui_sd_dreamer_main(object):
    def setupUi(self, sd_dreamer_main):
        ...
        sd_dreamer_main.resize(1347, 996)
        ...
        self.gridLayout.addWidget(self.previousImgButton, 3, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.nextImageButton, 3, 2, 1, 2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 716, 699))
        ...
        self.gridLayout.addWidget(self.scrollArea, 1, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.groupBox_4, 4, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.processOutput, 5, 0, 1, 6)
        ...
        self.gridLayout_8.addWidget(self.img2imgFile, 1, 0, 1, 5)

        self.imgFileSelect = QToolButton(self.tab_2)
        self.imgFileSelect.setObjectName(u"imgFileSelect")

        self.gridLayout_8.addWidget(self.imgFileSelect, 1, 5, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.imgIndex, 3, 5, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.artButton, 3, 0, 1, 5)
        ...
        self.gridLayout_8.addWidget(self.img2imgStrength, 2, 1, 1, 2)
        ...
        self.txt2imgHD_steps.setValue(100)
        ...
        self.gridLayout_14.addWidget(self.tabWidget, 3, 0, 1, 3)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 579, 364))
        ...
        self.gridLayout_2.addWidget(self.samplerToggle, 7, 2, 1, 2)

        self.label_25 = QLabel(self.scrollAreaWidgetContents_3)
        self.label_25.setObjectName(u"label_25")

        self.gridLayout_2.addWidget(self.label_25, 4, 3, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.precisionToggle, 8, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.label_6, 3, 3, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.batchVal, 6, 2, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.scrollArea_2, 0, 0, 1, 3)

        self.img2imgRadio = QRadioButton(self.tab_3)
        self.img2imgRadio.setObjectName(u"img2imgRadio")
        self.img2imgRadio.setChecked(False)

        self.gridLayout_14.addWidget(self.img2imgRadio, 1, 1, 1, 1)

        self.txt2imgRadio = QRadioButton(self.tab_3)
        self.txt2imgRadio.setObjectName(u"txt2imgRadio")
        self.txt2imgRadio.setChecked(True)

        self.gridLayout_14.addWidget(self.txt2imgRadio, 1, 0, 1, 1)

        self.txt2imgHDCheck = QRadioButton(self.tab_3)
        self.txt2imgHDCheck.setObjectName(u"txt2imgHDCheck")

        self.gridLayout_14.addWidget(self.txt2imgHDCheck, 1, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.rnvModelPathSelect, 13, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.outputFolderSelect, 4, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.pyBinSelect, 7, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.rnvBinPathSelect, 10, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.tabby, 1, 0, 4, 1)

        self.imgFilename = QLabel(sd_dreamer_main)
        self.imgFilename.setObjectName(u"imgFilename")
        self.imgFilename.setMaximumSize(QSize(353, 16777215))

        self.gridLayout.addWidget(self.imgFilename, 2, 2, 1, 1)
    ...
    def retranslateUi(self, sd_dreamer_main):
        ...
        self.label_4.setText(QCoreApplication.translate("sd_dreamer_main", u"Requires Real-ESRGAN", None))
        ...
        self.txt2imgHDCheck.setText(QCoreApplication.translate("sd_dreamer_main", u"txt2imgHD", None))
        self.label_12.setText(QCoreApplication.translate("sd_dreamer_main", u"TextLabel", None))
        ...
        self.label_13.setText(QCoreApplication.translate("sd_dreamer_main", u"Checkpoint", None))
#if QT_CONFIG(tooltip)
