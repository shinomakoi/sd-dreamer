...
class Ui_sd_dreamer_main(object):
    def setupUi(self, sd_dreamer_main):
        ...
        sd_dreamer_main.resize(1038, 618)
        ...
        self.gridLayout_2.addWidget(self.outputFolderSelect, 15, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_5, 15, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.generateButton, 31, 1, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.precisionToggle, 11, 2, 1, 1)

        self.outputFolderLine = QLineEdit(self.tab_3)
        self.outputFolderLine.setObjectName(u"outputFolderLine")

        self.gridLayout_2.addWidget(self.outputFolderLine, 15, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.groupBox, 16, 4, 2, 3)
        ...
        self.gridLayout_2.addWidget(self.groupBox_3, 15, 1, 3, 2)
