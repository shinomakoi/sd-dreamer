...
class Ui_sd_dreamer_main(object):
    def setupUi(self, sd_dreamer_main):
        ...
        sd_dreamer_main.resize(1345, 1090)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 823, 679))
        ...
        self.scrollArea_2.setFont(font2)
        ...
        self.negPromptVal.setFont(font5)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.gfpganStrength.setToolTip(QCoreApplication.translate("sd_dreamer_main", u"Strength of GFPGAN face restoration", None))
#endif // QT_CONFIG(tooltip)
