...
class Ui_sd_dreamer_main(object):
    def setupUi(self, sd_dreamer_main):
        ...
        sd_dreamer_main.resize(997, 740)
        ...
        self.gridLayout_6.addWidget(self.img2imgSelect, 2, 3, 1, 1)

        self.txt2imgSelect = QPushButton(self.groupBox_2)
        self.txt2imgSelect.setObjectName(u"txt2imgSelect")

        self.gridLayout_6.addWidget(self.txt2imgSelect, 1, 3, 1, 1)
    ...
    def retranslateUi(self, sd_dreamer_main):
        ...
        self.samplerToggle.setItemText(1, QCoreApplication.translate("sd_dreamer_main", u"k_lms", None))
        self.samplerToggle.setItemText(2, QCoreApplication.translate("sd_dreamer_main", u"plms", None))
        ...
        self.label_12.setText(QCoreApplication.translate("sd_dreamer_main", u"0.1 - 1.0", None))
...
#endif // QT_CONFIG(tooltip)
        self.label_10.setText(QCoreApplication.translate("sd_dreamer_main", u"k_lms requires the *klms_sdd.py script and K-Diffusion installed", None))
