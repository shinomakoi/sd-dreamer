- Have a working Stable Diffusion install (tested on the default CompVis,basujindal,hlky versions)
- IMPORTANT:Place the SD dreamer folder in the base of your stable diffusion folder (e.g. in stable-diffusion folder)
...
- Run the program and set the necessary paths.
